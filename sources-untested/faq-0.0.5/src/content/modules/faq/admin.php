...
function faq_admin() {
   ...
   answer='$answer' WHERE id = $id");
        ...
        <form action="?action=module_settings&module=faq&do=list" method="post">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="question" size="50" maxlength="255"
                               value="Warum ist die Banane Krum?"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center"><input type="hidden" name="create-faq"
                                                          value="create-faq">
                        <p>
    ...
    if ($action == "edit") {
        ...
        <form action="?action=module_settings&module=faq&do=list" method="post">
            ...
            <table>
                <tr>
                    <td style="width: 150px">Frage</td>
                    <td><input type="text" size="50" maxlength="255" name="question"
                               value="<?php echo htmlspecialchars($data->question, ENT_QUOTES, "utf-8"); ?>"></td>
                </tr>
                <tr>
                    <td style="width: 150px">Antwort</td>
                    <td><textarea name="answer" cols="50" rows="10"><?php echo htmlspecialchars($data->answer); ?></textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align: center"><input type="hidden" name="edit-faq"
    ...
    if ($action == "list") {
        ?>
        <p>
            <strong><a href="?action=module_settings&module=faq&do=new">[Frage
                    erstellen]</a></strong>
        </p>
        <?php
        ...
        if (db_num_rows($sql) > 0) {
            ...
            <table style="width: 100%">
                ...
                while ($row = db_fetch_object($sql)) {
                    ...
                    echo '<td style="text-align:center">' . '<a href="?action=module_settings&module=faq&do=delete&delete=' . $row->id . '" onclick="return confirm(\'Wirklich löschen?\')"><img src="gfx/delete.png" alt="Löschen" title="Löschen"></a>' . '</td>';
                    echo '</tr>';
                }
                ?>
            </table>
