<?php
if (containsModule(get_slug(), "google_maps")) {
    ...
    if ($google_maps_marker and $google_maps_zoom_level) {
        ...
        <script type="text/javascript"
        src="<?php echo getModulePath("google_maps"); ?>gmap3.min.js"></script>



        <link rel="stylesheet" type="text/css"
              href="<?php echo getModulePath("google_maps"); ?>style.css" />
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#gmap3').gmap3({
                    marker: {
                        address: "<?php esc($google_maps_marker); ?>"
                    },
                    map: {
                        options: {
                            zoom: <?php esc($google_maps_zoom_level); ?>
                        }
                    }
                });
