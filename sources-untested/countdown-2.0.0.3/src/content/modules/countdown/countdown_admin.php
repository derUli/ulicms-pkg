        ...
        <table style="border: 0px">
            <tr>
                ...
                <td><input name="countdown_to_date" type="datetime-local"
                           value="<?php echo date("Y-m-d\TH:i:s", $countdown_to_date); ?>"></td>
            </tr>
            <tr>
                <td><strong>Breite</strong></td>
                <td><input name="countdown_width" type="number" step="any"
                           value="<?php echo $countdown_width; ?>"></td>
            </tr>
            <tr>
                <td><strong>Höhe</strong></td>
                <td><input name="countdown_height" type="number" step="any"
                           value="<?php echo $countdown_height; ?>"></td>
            </tr>
            <tr>
                <td><strong>Zielelement</strong></td>
                <td><input type="text" name="countdown_target"
                           value="<?php esc($countdown_target) ?>"></td>
            </tr>
            <tr>
                <td><strong>onComplete Funktion</strong></td>
                <td><input type="text" name="countdown_oncomplete"
                           value="<?php echo esc($countdown_oncomplete) ?>"></td>
            </tr>
            <tr>
