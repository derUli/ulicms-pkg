...
function google_analytics_admin() {
    if (isset($_POST ["submit"])) {
        setconfig("google_analytics_id", db_escape($_POST ["google_analytics_id"]));
    }
    ...
    <form action="<?php echo getModuleAdminSelfPath() ?>" method="post">
        <?php csrf_token_html(); ?>
        <p>
            Web-Property-ID: <input name="google_analytics_id" type="text"
                                    value="<?php echo htmlspecialchars($ga_id); ?>">
        </p>
