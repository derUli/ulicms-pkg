...
$_result, $server_info, $affected_rows, $errno, $error, $pdo;
...
$extension = "MySQL", $server_info, $affected_rows, $errno, $error, $_link, $_result;
...
$E = ($Ag == DB ? table("copy_$Q") : idf_escape($Ag) . "." . table($Q));
$vh = view($Q);
if (($_POST["overwrite"] &&!queries("DROP VIEW IF EXISTS $E")) ||!queries("CREATE VIEW $E AS $vh[select]"))
return
false;
}return
true;
