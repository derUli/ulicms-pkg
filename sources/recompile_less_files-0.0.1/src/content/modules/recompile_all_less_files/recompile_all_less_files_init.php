...
function recompile_all_less_files(){
    // @TODO lessc.inc.php zum Paket. Derzeit funktioniert der Download nicht.
    require_once getModulePath("recompile_all_less_files")."lessc.inc.php";
	...
	foreach($less_files as $input_file){
	   ...
	   $less->setImportDir(array($path_parts['dirname']));
	   try{
