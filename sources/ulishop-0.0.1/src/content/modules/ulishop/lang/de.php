<?php
$TRANSLATION_ULISHOP_SEPERATOR = htmlspecialchars ( "->" );
define ( "TRANSLATION_PRODUCT", "UliShop $TRANSLATION_ULISHOP_SEPERATOR Produkt" );
define ( "TRANSLATION_PRICE", "Preis" );
define ( "TRANSLATION_SPECIAL_TAX", "Spezieller Mehrwertsteuersatz (in Prozent)" );
