...
?>" />
    ...
    <img class="M_bord" src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/bord.png');
?>" alt="" />
...
?>" />
    ...
    <a href="#" onclick="Grid(); return false" class="M_butt" id="grid_button" target="_self">
        <img title="<?php echo __('Snap to grid') ?>"
            src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/grid.png');
?>" alt="" />
    </a>
    <img class="M_bord" src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/bord.png');
?>" alt="" />
    <a href="#" onclick="Small_tab_all(document.getElementById('key_SB_all')); return false"
        class="M_butt" target="_self">
        <img id='key_SB_all' title="<?php echo __('Small/Big All');
?>" alt="v"
...
?>" alt="" />
    <a href="#" onclick="PDF_save(); return false" class="M_butt ajax">
        <img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/pdf.png');
?>" alt="key"
...
?>" id='key_HS_all' /></a>
    ...
    <img title="<?php echo __('Hide/Show Tables with no relation');
?>" alt="v"
...
<table id="<?php echo $t_n_url ?>" cellpadding="0" cellspacing="0" class="pmd_tab"
   style="position: absolute;
          left: <?php
     echo isset($tab_pos[$t_n]) ? $tab_pos[$t_n]["X"] : rand(20, 700);
    ?>px;
          top: <?php
     echo isset($tab_pos[$t_n]) ? $tab_pos[$t_n]["Y"] : rand(20, 550);
    ?>px;
          visibility: <?php
    ...
    <td width="10px" colspan="3"
        ...
        <?php
         if (isset($tables_pk_or_unique_keys[$t_n . "." . $tab_column[$t_n]["COLUMN_NAME"][$j]])){
             ?>
                <img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath();
...
<tr>
    ...
    <td class="input_tab">
        ...
        <thead>
        <tr>
            <td colspan="2" class="center nowrap"><strong><?php echo __('Create relation');
?></strong></td>
        </tr>
        </thead>
...
<tr>
    ...
    <td class="input_tab">
        ...
        <tr>
            <td colspan="3" class="center nowrap"><strong><?php echo __('Delete relation');
?></strong></td>
        </tr>
        <tr>
...
<tr>
    ...
    <td class="input_tab">
       ...
       <thead>
        ...
        <tr>
        <td width="58" class="nowrap"><?php echo __('Relation operator');
?></td>
            <td width="102"><select name="rel_opt" id="rel_opt">
                    ...
                    <option value="EXCEPT"> <?php echo __('Except');
?> </option>
        ...
        <tr>
        <td class="nowrap"><?php echo __('Value');
?>/<br /><?php echo __('subquery');
?></td>
            <td><textarea id="Query" value="" cols="18"></textarea>
            </td>
        </tr>
        <tr><td class="center nowrap"><b><?php echo __('Rename to');
?></b></td></tr>
        <tr>
        <td width="58" class="nowrap"><?php echo __('New name');
?></td>
            <td width="102"><input type="text" value="" id="new_name"/></td>
        </tr>
        <tr><td class="center nowrap"><b><?php echo __('Aggregate');
?></b></td></tr>
         <tr>
         <td width="58" class="nowrap"><?php echo __('Operator');
?></td>
...
?> </option>
            ...
            <tr>
            <td width="58" class="nowrap"><?php echo __('Value');
?>/<br/><?php echo __('subquery');
?></td>
...
<tr>
    ...
    <td class="input_tab">
        ...
        <thead>
        <tr>
        <td colspan="2" class="center nowrap"><strong><?php echo __('Rename to');
?></strong></td>
        </tr>
        </thead>
        <tbody id="rename_to">
...
<tr>
    ...
    <td class="input_tab">
        ...
        <thead>
        <tr>
        <td colspan="2" class="center nowrap"><strong><?php echo __('Aggregate');
?></strong></td>
        </tr>
        </thead>
        <tbody>
...
<!-- cache images -->
<img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/2leftarrow_m.png');
?>" width="0" height="0" alt="" />
<img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/rightarrow1.png');
?>" width="0" height="0" alt="" />
<img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/rightarrow2.png');
?>" width="0" height="0" alt="" />
<img src="<?php echo $_SESSION['PMA_Theme'] -> getImgPath('pmd/uparrow2_m.png');
?>" width="0" height="0" alt="" />
