...
<fieldset>
    <legend><?php echo __('Display GIS Visualization');
?></legend>
...
?>
    ...
    <tr><td><label for="labelColumn"><?php echo __("Label column");
?></label></td>
...
foreach ($labelCandidates as $labelCandidate){
 ...
 ?>
    ...
    <tr><td><label for="spatial Column"><?php echo __("Spatial column");
?></label></td>
...
foreach ($spatialCandidates as $spatialCandidate){
 ...
 ?>
    ...
    <tr><td></td>
        <td class="button"><input type="submit" name="displayVisualizationBtn" value="<?php echo __('Redraw');
?>" /></td>
    </tr>
<?php
if (! $GLOBALS['PMA_Config'] -> isHttps()){
    ...
    <?php
     ...
     ?>
        />
        <label for="choice"><?php echo __("Use OpenStreetMaps as Base Layer");
    ?></label>
    </td></tr>
    <?php
    }
...
?>
    <table class="gis_table">
    <tr><td><label for="fileName"><?php echo __("File name");
?></label></td>
        <td><input type="text" name="fileName" id="fileName" /></td>
    </tr>
    <tr><td><label for="fileFormat"><?php echo __("Format");
?></label></td>
...
if ($svg_support){
 ...
 ?>
    ...
    <tr><td></td>
        <td class="button"><input type="submit" name="saveToFileBtn" value="<?php echo __('Download');
?>" /></td>
    </tr>
    </table>
...
?>" />
    ...
    <div id="placeholder" style="width:<?php echo htmlspecialchars($visualizationSettings['width']);
?>px;height:<?php echo htmlspecialchars($visualizationSettings['height']);
?>px;">
