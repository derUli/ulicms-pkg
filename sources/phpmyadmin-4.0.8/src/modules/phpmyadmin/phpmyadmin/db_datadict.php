...
<tr><th width="50"><?php echo __('Column');
    ?></th>
    <th width="80"><?php echo __('Type');
    ?></th>
<?php/**
     * <th width="50"><?php echo __('Attributes'); ?></th>
     */ ?>
    <th width="40"><?php echo __('Null');
    ?></th>
    <th width="70"><?php echo __('Default');
    ?></th>
<?php/**
...
<tr class="<?php echo $odd_row ? 'odd' : 'even';
    ...
    <td<?php echo $type_nowrap;
        ?> lang="en" dir="ltr"><?php echo $type;
        ?></td>
<?php/**
         * <td<?php echo $type_nowrap; ?>><?php echo $attribute; ?></td>
         */ ?>
    <td><?php echo (($row['Null'] == 'NO') ? __('No') : __('Yes'));
        ?></td>
    <td class="nowrap"><?php
         if (isset($row['Default'])){
             echo $row['Default'];
