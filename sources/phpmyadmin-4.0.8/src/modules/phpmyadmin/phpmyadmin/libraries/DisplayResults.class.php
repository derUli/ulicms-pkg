         ...
         for ($currentColumn = 0;
            ...
            $i = $col_order ? $col_order[$currentColumn] : $currentColumn;
             ...
             $hide_class = ($col_visib && ! $col_visib[$currentColumn]
                 // hide per <td> only if the display dir is not vertical&& ($_SESSION['tmp_user_values']['disp_direction']
        ...
        $category, $content, $transformation_plugin, $transform_options,
         ...
         if (gettype($transformation_plugin) == "object"
                 && (strpos($transformation_plugin -> getMIMESubtype(), 'Octetstream')
                     // if we want to use a text transformation on a BLOB column|| strpos($transformation_plugin -> getMIMEtype(), 'Text') !== false)
                ){
             $result = $content;
             }
