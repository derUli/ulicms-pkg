    ...
    if (!isset($PMA_SQPdata_column_attrib)){
     ...
     while ($count2 < $len){
        ...
        if (PMA_STR_isSqlIdentifier($c, false)
            ...
            /**
             * can also be present in expressions like
             * FROM 'user'@'%' or  TO 'user'@'%'
             * in this case, the
             * is wrongly marked as alpha_variable
             * 
             * @todo a
             */
     ...
     if (isset($arr[$i + 1]) && $arr[$i + 1]['type'] == 'alpha_reservedWord'){
         ...
         if (isset($clause)
                 && ($arr[$i + 2]['type'] == 'alpha_reservedWord'
                    ...
                    // 'no' as an identifier)|| ($arr[$i + 2]['type'] == 'alpha_identifier'
 ...
 * 
 * @see 
 * @todo 2005-10-16 note: the "or" part here is a workaround for a bug
 */
