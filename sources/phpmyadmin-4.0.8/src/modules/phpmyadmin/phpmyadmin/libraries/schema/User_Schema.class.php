...
class PMA_User_Schema
{
     ...
     public function showCreatePageDialog($db)
    {
        ...
        <table>
        <tr>
        <td><label for="id_newpage"><?php echo __('Page name');
        ?></label></td>
        <td>
     ...
     public function selectPage()
    {
         ...
         if ($page_rs && PMA_DBI_num_rows($page_rs) > 0){
            ...
            <option value="0"><?php echo __('Select page');
            ?></option>
            <?php
     ...
     public function displaySchemaGenerationOptions()
    {
        ...
        <form method="post" action="schema_export.php" class="disableAjax">
         ...
         ?>:
            ...
            <label><?php echo __('Select Export Relational Type');
        ?></label><br />
            <?php
         if (isset($test_rs)){
             ?>
            <label for="pdf_page_number_opt"><?php echo __('Page number:');
            ?></label>
        ...
        ?>" />
            ...
            <label for="show_grid_opt"><?php echo __('Show grid');
        ?></label><br />
            <input type="checkbox" name="show_color" id="show_color_opt" checked="checked" />
            <label for="show_color_opt"><?php echo __('Show color');
        ?></label>
            <br />
        ...
        ?>
            ...
            <label for="with_doc"><?php echo __('Data Dictionary');
        ?></label><br />
            <input type="checkbox" name="show_keys" id="show_keys" />
            <label for="show_keys"><?php echo __('Only show keys');
        ?></label><br />
            <select name="orientation" id="orientation_opt" class="paper-change">
                <option value="L"><?php echo __('Landscape');
        ?></option>
                <option value="P"><?php echo __('Portrait');
        ?></option>
            </select>
            <label for="orientation_opt"><?php echo __('Orientation');
        ?></label>
            <br />
         ...
         ?>
            ...
            <label for="paper_opt"><?php echo __('Paper size');
        ?></label>
            </fieldset>
            <fieldset class="tblFooters">
            <input type="submit" value="<?php echo __('Go');
