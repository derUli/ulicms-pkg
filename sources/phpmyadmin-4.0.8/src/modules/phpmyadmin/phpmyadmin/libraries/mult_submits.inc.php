...
if (!empty($submit_mult) && !empty($what)){
    ...
    $_url_params = array(
     ...
     if ($what == 'replace_prefix_tbl' || $what == 'copy_tbl_change_prefix'){
        ...
        <fieldset class = "input">
                ...
                <tr>
                <td><?php echo __('From');
        ?></td><td><input type="text" name="from_prefix" id="initialPrefix" /></td>
                </tr>
                <tr>
                <td><?php echo __('To');
        ?> </td><td><input type="text" name="to_prefix" id="newPrefix" /></td>
                </tr>
                </table>
        </fieldset>
    ...
    <?php
        ...
        <fieldset class = "input">
                ...
                <table>
                <tr>
                <td><?php echo __('Add prefix');
        ?></td>     <td><input type="text" name="add_prefix" id="txtPrefix" /></td>
                </tr>
                </table>
        </fieldset>
        <fieldset class="tblFooters">
    ...
    <?php
        ...
        if ($what == 'drop_tbl'){
            ?>
                ...
                <span class="fkc_switch"><?php echo __('Foreign key check:');
            ?></span>
             ...
             echo ($default_fk_check_value) ? ' checked="checked"' : '' ?>/></span>
                <span id="fkc_status" class="fkc_switch"><?php echo ($default_fk_check_value) ? __('(Enabled)') : __('(Disabled)');
            ?></span>
                </div><?php
             }
        ?>
