...
<h2><?php echo __('Available MIME types');
?></h2>
<?php
...
?>
<br />
<h2><?php echo __('Available transformations');
?></h2>
<table width="90%">
<thead>
<tr>
    <th><?php echo __('Browser transformation');
?></th>
    <th><?php echo _pgettext('for MIME transformation', 'Description');
?></th>
</tr>
</thead>
<tbody>
