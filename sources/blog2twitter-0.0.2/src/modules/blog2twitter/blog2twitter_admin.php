...
function blog2twitter_admin(){
     ...
     if(isset($_POST["submit"])){
        ...
        mysql_real_escape_string($_POST["blog2twitter_consumer_key"]));
        
        setconfig("blog2twitter_consumer_secret", 
        mysql_real_escape_string($_POST["blog2twitter_consumer_secret"]));
        
        setconfig("blog2twitter_access_token", 
        mysql_real_escape_string($_POST["blog2twitter_access_token"]));
        
        setconfig("blog2twitter_access_token_secret", 
        mysql_real_escape_string($_POST["blog2twitter_access_token_secret"]));
