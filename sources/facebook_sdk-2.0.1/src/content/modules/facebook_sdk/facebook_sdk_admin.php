...
function facebook_sdk_admin() {
	if (isset ( $_POST ["submit"] )) {
		setconfig ( "facebook_app_id", db_escape ( $_POST ["facebook_app_id"] ) );
	}
...
if (function_exists ( "csrf_token_html" ))
	...
	?>
<p>
		<strong>Facebook App-ID</strong> <input name="facebook_app_id"
			required="true" type="text"
			value="<?php
	
echo htmlspecialchars ( $facebook_app_id );
	?>">
	</p>
	<p>
