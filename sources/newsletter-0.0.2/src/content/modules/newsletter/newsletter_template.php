...
if (isset ( $_POST ["submit"] )) {
	...
	setconfig ( "newsletter_template_title", db_escape ( $_POST ["template_title"] ) );
	
	setconfig ( "newsletter_template_content", db_escape ( $_POST ["template_content"] ) );
...
<p>
		<strong>Titel: </strong><input type="text" maxlength=78 size=78
			name="template_title"
			value="<?php echo htmlspecialchars(NEWSLETTER_TEMPLATE_TITLE)?>">
	</p>


	<p>
		<textarea id="template_content" name="template_content" cols=60
			rows=16><?php
