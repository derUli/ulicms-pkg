         ...
         for ($currentColumn = 0;
            ...
            $i = $col_order ? $col_order[$currentColumn] : $currentColumn;
             ...
             $hide_class = ($col_visib && ! $col_visib[$currentColumn]
                 // hide per <td> only if the display dir is not vertical&& ($_SESSION['tmpval']['disp_direction']
         ...
         if (isset($meta -> _type) && $meta -> _type === MYSQLI_TYPE_BIT){
            ...
            if (stristr($result, $binary_or_blob)){
             ...
             $formatted = true;
                 ...
                 && (/**
                     * overload
                     */mb_strpos($column, ".") !== false) // micro seconds delimiter
                ){
