...
function blog_add_form() {
	...
	$html_output .= "<form action='" . buildSEOUrl ( get_requested_pagename () ) . "?blog_admin=submit' method='post' style=''>";
	...
	$html_output .= "</td>";
	$html_output .= "<td>";
	$html_output .= "http://" . $_SERVER ["SERVER_NAME"] . "/pfad/zu/ulicms/" . get_requested_pagename () . ".html?single=<input style=<input style='font-weight:bold;background-color:rgb(240, 240, 240);border:0px;' name='seo_shortname' type='text' maxlength=200 size=30>";
	$html_output .= "</td>";
	$html_output .= "</tr>";
