...
csrf_token_html ();
	?>
<p>
		<input name="remote_api_enabled" type="checkbox"
			<?php if($remote_api_enabled) echo " checked=\"checked\""?>>
		Aktiviert
	</p>
	<p>
		Wenn UliCMS sich im Root-Verzeichnis Ihrer Domain befindet, lautet die
		Remote-URL in den meisten Fällen: <br /> <input type="text"
			readonly="readonly" name="remote_url"
			value="<?php
