...
function blog_display_comments($post_id) {
	...
	} else if (getconfig("disallow_rtl_chars") and $spamfilter_enabled and ( AntispamHelper::isRtl($_POST["name"]) or AntispamHelper::isRtl($_POST["comment"]))) {
		Settings::set("contact_form_refused_spam_mails", Settings::get("contact_form_refused_spam_mails") + 1);
		if ($_SESSION["language"] == "de") {
			$html .= "<p class='ulicms-error'>" .
	...
	} else if ($spamfilter_enabled and ( AntiSpamHelper::containsBadwords($_POST["name"])
