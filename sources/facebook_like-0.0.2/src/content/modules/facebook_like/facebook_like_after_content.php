...
echo htmlspecialchars(getCurrentURL()); ?>"
	data-layout="<?php
    
echo $facebook_like_button_layout; ?>"
	data-colorscheme="<?php
    
echo $facebook_like_button_data_colorscheme; ?>"
	data-action="<?php
    
echo $facebook_like_button_action; ?>"
	data-show-faces="<?php
    
echo $facebook_like_button_show_faces; ?>"
	data-share="<?php
    
echo $facebook_like_button_share; ?>"></div>
<?php
}
?>
