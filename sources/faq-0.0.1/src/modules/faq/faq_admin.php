...
<tr>
<td style="width:150px">Frage</td>
<td><input type="text" size="50" maxlength="255" name="question" value="<?php echo htmlspecialchars($data -> question, ENT_QUOTES, "utf-8");
        ?>"></td>
</tr>
<tr>
<td style="width:150px">Antwort</td>
<td><textarea name="answer" cols="50" rows="10"><?php echo htmlspecialchars($data -> answer);
        ?></textarea></td>
</tr>
<tr>
<td>
