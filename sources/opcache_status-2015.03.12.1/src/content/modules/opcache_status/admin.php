...
define ( "MODULE_ADMIN_HEADLINE", "OPcache Status" );
define ( "MODULE_ADMIN_REQUIRED_PERMISSION", "opcache_status" );
function opcache_status_admin() {
	if (! extension_loaded ( 'Zend OPcache' )) {
		...
		require getModulePath ( "opcache_status" ) . 'data-sample.php';
	}
...
<div id="graph">
	<form>
		<label><input type="radio" name="dataset" value="memory" checked>
			Memory</label> <label><input type="radio" name="dataset" value="keys">
			Keys</label> <label><input type="radio" name="dataset" value="hits">
			Hits</label> <label><input type="radio" name="dataset"
			value="restarts"> Restarts</label>
	</form>
